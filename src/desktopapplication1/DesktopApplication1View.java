...
public class DesktopApplication1View extends FrameView {
    ...
    private void initComponents() {
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .addComponent(statusPanelSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 1079, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         //ImageIcon icon = createImageIcon("resources/ashlesha.png","ashlesha");
        //jLabel2 = new JLabel(icon);
        //jLabel2.setText("@Image: Y U NO COME ?");
        //jLabel2.getIcon();
        //jLabel3.setIcon(jLabel2.getIcon());
        jLabel2.setIcon(new ImageIcon(getClass().getResource("/resources/ashlesha.png")));
    ...
    if (imgURL != null) {
        ...
        System.err.println("Couldn not find file: " + path);
        return null;
    }
} 
   /* public void init(){
        try{
            ...
            new Runnable(){
                ...
                System.out.println("cant create beacause of" +exc);
    ...
    private void makeGUI(){
        ImageIcon i1=new ImageIcon("ashlesha");
        JLabel j1=new JLabel("ashlesha",i1,JLabel.CENTER);
    }
   */
